...
SELECT BOA.installation.ID, BOA.installation.NAME, BOA.installation.COMMENTS,
       ...
       BOA.getUserName(BOA.installation.USER_ID) AS INCHARGE, BOA.installation.STARTINGDATE,
       BOA.getName(BOA.getLocationID(BOA.installation.ID,"Installation")) AS LOCATION,
...
SELECT BOA.tool.ID, BOA.tool.NAME, BOA.tool.DESIGNATION, BOA.tool.PERSONINCHARGE AS INCHARGE,
       ...
       BOA.getBoolean(BOA.getInheritedLocation(BOA.tool.ID,"Tool")) AS INHERITEDLOCATION,
       BOA.getName(BOA.getLocationID(BOA.tool.ID,"Tool")) AS LOCATION,
       BOA.getLocationDetails(BOA.tool.ID,"Tool") AS DETAILSONLOCATION,
       BOA.getName(BOA.getExternalLocationID(BOA.tool.ID,"Tool")) AS EXTERNALLOCATION,
       BOA.getType(BOA.getContainerID(BOA.tool.ID,"Tool")) AS PARENTTYPE,
       BOA.getName(BOA.getContainerID(BOA.tool.ID,"Tool")) AS PARENT,
       BOA.getContainerDetails(BOA.tool.ID,"Tool") AS DETAILSONPARENT,
       BOA.getType(BOA.getMasterContainerID(BOA.tool.ID,"Tool")) AS MASTERPARENTTYPE,
       BOA.getName(BOA.getMasterContainerID(BOA.tool.ID,"Tool")) AS MASTERPARENT,
...
SELECT BOA.cabinet.ID, BOA.cabinet.DESIGNATION,
       ...
       BOA.article.CMSCODE,
       BOA.article.STATE,
       BOA.getBoolean(BOA.getInheritedLocation(BOA.article.ID,"Cabinet")) AS INHERITEDLOCATION,
       BOA.getName(BOA.getLocationID(BOA.article.ID,"Cabinet")) AS LOCATION,
       BOA.getLocationDetails(BOA.article.ID,"Cabinet") AS DETAILSONLOCATION,
       BOA.getName(BOA.getExternalLocationID(BOA.article.ID,"Cabinet")) AS EXTERNALLOCATION,
       BOA.getType(BOA.getContainerID(BOA.article.ID,"Cabinet")) AS PARENTTYPE,
       BOA.getName(BOA.getContainerID(BOA.article.ID,"Cabinet")) AS PARENT,
       BOA.getContainerDetails(BOA.article.ID,"Cabinet") AS IDENTIFICATIONLETTER_DETAILSONPARENT,
...
SELECT BOA.rack.ID, BOA.rack.DESIGNATION,
       ...
       BOA.article.CMSCODE,
       BOA.article.STATE,
       BOA.getBoolean(BOA.getInheritedLocation(BOA.article.ID,"Rack")) AS INHERITEDLOCATION,
       BOA.getName(BOA.getLocationID(BOA.article.ID,"Rack")) AS LOCATION,
       BOA.getLocationDetails(BOA.article.ID,"Rack") AS DETAILSONLOCATION,
       BOA.getName(BOA.getExternalLocationID(BOA.article.ID,"Rack")) AS EXTERNALLOCATION,
       BOA.getType(BOA.getContainerID(BOA.article.ID,"Rack")) AS PARENTTYPE,
       BOA.getName(BOA.getContainerID(BOA.article.ID,"Rack")) AS PARENT,
       BOA.getContainerDetails(BOA.article.ID,"Rack") AS RACKPOSITION_DETAILSONPARENT,
       BOA.getType(BOA.getMasterContainerID(BOA.article.ID,"Rack")) AS MASTERPARENTTYPE,
       BOA.getName(BOA.getMasterContainerID(BOA.article.ID,"Rack")) AS MASTERPARENT,
       BOA.article.ACQUISITIONDATE AS ACQUISITIONDATE,
       BOA.comment.MESSAGE AS GENERALCOMMENT
FROM BOA.rack
...
SELECT BOA.switch.ID,
       ...
       BOA.getBoolean(BOA.getInheritedLocation(BOA.article.ID,"Switch")) AS INHERITEDLOCATION,
       BOA.getName(BOA.getLocationID(BOA.article.ID,"Switch")) AS LOCATION,
       BOA.getLocationDetails(BOA.article.ID,"Switch") AS DETAILSONLOCATION,
       BOA.getName(BOA.getExternalLocationID(BOA.article.ID,"Switch")) AS EXTERNALLOCATION,
       BOA.getType(BOA.getContainerID(BOA.article.ID,"Switch")) AS PARENTTYPE,
       BOA.getName(BOA.getContainerID(BOA.article.ID,"Switch")) AS PARENT,
       BOA.getContainerDetails(BOA.article.ID,"Switch") AS SWITCHPOSITION_DETAILSONPARENT,
       BOA.getType(BOA.getMasterContainerID(BOA.article.ID,"Switch")) AS MASTERPARENTTYPE,
       BOA.getName(BOA.getMasterContainerID(BOA.article.ID,"Switch")) AS MASTERPARENT,
       BOA.article.ACQUISITIONDATE AS ACQUISITIONDATE,
       BOA.comment.MESSAGE AS GENERALCOMMENT
FROM BOA.switch
...
SELECT BOA.pc.ID,
       ...
       BOA.pc.FUNCTION, BOA.getUserName(BOA.user.ID) AS INCHARGE,
       ...
       BOA.pc.ASSIGNMENT,
       BOA.getSoftwareName(BOA.pc.DEFAULTOS_SOFTWARE_ID) AS DEFAULT_OS,
       BOA.domain.DEFAULTVALUE AS DOMAIN, BOA.pc.PLATFORM,
       BOA.getBoolean(BOA.getInheritedLocation(BOA.article.ID,"PC")) AS INHERITEDLOCATION,
       BOA.getName(BOA.getLocationID(BOA.article.ID,"PC")) AS LOCATION,
       BOA.getLocationDetails(BOA.article.ID,"PC") AS DETAILSONLOCATION,
       BOA.getName(BOA.getExternalLocationID(BOA.article.ID,"PC")) AS EXTERNALLOCATION,
       BOA.getType(BOA.getContainerID(BOA.article.ID,"PC")) AS PARENTTYPE,
       BOA.getName(BOA.getContainerID(BOA.article.ID,"PC")) AS PARENT,
       BOA.getContainerDetails(BOA.article.ID,"PC") AS DETAILSONPARENT,
       BOA.getType(BOA.getMasterContainerID(BOA.article.ID,"PC")) AS MASTERPARENTTYPE,
       BOA.getName(BOA.getMasterContainerID(BOA.article.ID,"PC")) AS MASTERPARENT,
...
SELECT BOA.pc.ID,
       ...
       BOA.getBoolean(BOA.memoryslot.USED) AS MEMORY_SLOT_USED,
...
SELECT BOA.board.ID,
       ...
       BOA.getBoolean(BOA.getInheritedLocation(BOA.article.ID,"Board")) AS INHERITEDLOCATION,
       BOA.getName(BOA.getLocationID(BOA.article.ID,"Board")) AS LOCATION,
       BOA.getLocationDetails(BOA.article.ID,"Board") AS DETAILSONLOCATION,
       BOA.getName(BOA.getExternalLocationID(BOA.article.ID,"Board")) AS EXTERNALLOCATION,
       BOA.getType(BOA.getContainerID(BOA.article.ID,"Board")) AS PARENTTYPE,
       BOA.getName(BOA.getContainerID(BOA.article.ID,"Board")) AS PARENT,
       BOA.getContainerDetails(BOA.article.ID,"Board") AS SLOTNUMBERPOSITION_DETAILSONPARENT,
       BOA.getType(BOA.getMasterContainerID(BOA.article.ID,"Board")) AS MASTERPARENTTYPE,
       BOA.getName(BOA.getMasterContainerID(BOA.article.ID,"Board")) AS MASTERPARENT,
       BOA.article.ACQUISITIONDATE AS ACQUISITIONDATE,
       BOA.comment.MESSAGE AS GENERALCOMMENT
FROM BOA.board
...
SELECT BOA.various.ID,
       ...
       BOA.article.CMSCODE,
       BOA.article.STATE,
       BOA.getBoolean(BOA.getInheritedLocation(BOA.article.ID,"Various")) AS INHERITEDLOCATION,
       BOA.getName(BOA.getLocationID(BOA.article.ID,"Various")) AS LOCATION,
       BOA.getLocationDetails(BOA.article.ID,"Various") AS DETAILSONLOCATION,
       BOA.getName(BOA.getExternalLocationID(BOA.article.ID,"Various")) AS EXTERNALLOCATION,
       BOA.getType(BOA.getContainerID(BOA.article.ID,"Various")) AS PARENTTYPE,
       BOA.getName(BOA.getContainerID(BOA.article.ID,"Various")) AS PARENT,
       BOA.getContainerDetails(BOA.article.ID,"Various") AS DETAILSONPARENT,
       BOA.getType(BOA.getMasterContainerID(BOA.article.ID,"Various")) AS MASTERPARENTTYPE,
       BOA.getName(BOA.getMasterContainerID(BOA.article.ID,"Various")) AS MASTERPARENT,
       BOA.article.ACQUISITIONDATE AS ACQUISITIONDATE,
       BOA.comment.MESSAGE AS GENERALCOMMENT
FROM BOA.various
...
SELECT BOA.getType(BOA.article.ID) AS FORARTICLE,
       BOA.article.AIRBUSSN, BOA.article.MANUFACTURERSN,
...
SELECT BOA.software.ID, BOA.software.NAME, BOA.software.DISTRIBUTION AS DISTRIBUTION_VERSION, BOA.software.KERNEL,
       BOA.getBoolean(BOA.software.OPERATINGSYSTEM) AS OPERATINGSYSTEM, BOA.software.MANUFACTURER,
...
SELECT BOA.getSoftwareName(BOA.software.ID) AS SOFTWARE,
...
SELECT BOA.article.DTYPE AS CLASS, BOA.article.AIRBUSSN, BOA.article.MANUFACTURERSN,
       BOA.getDesignation(BOA.article.ID) AS DESIGNATION,
       BOA.typearticle.LABEL AS TYPE,
       BOA.action.LOGIN, BOA.getActionLabel(BOA.action.LABEL) AS ACTION,
...
SELECT BOA.obsolescencedata.ID,
       BOA.getObsoReferenceType(BOA.obsolescencedata.ID) AS REFERENCEFAMILY,
       BOA.getObsoTypeArticle(BOA.obsolescencedata.ID) AS ARTICLETYPE,
       BOA.getObsoReferenceName(BOA.obsolescencedata.ID) AS REFERENCE,
       BOA.getObsoConstituentName(BOA.obsolescencedata.ID) AS CONSTITUENTNAME,
       BOA.obsolescencedata.LASTOBSOLESCENCEUPDATE AS LASTUPDATE,
       BOA.consultperiod.DEFAULTVALUE AS CONSULTPERIOD,
       BOA.getObsoNextConsultingDate(BOA.obsolescencedata.LASTOBSOLESCENCEUPDATE, BOA.consultperiod.MONTHNUMBER) AS NEXTCONSULTINGDATE,
       ...
       BOA.getObsoNumberOfArticles(BOA.obsolescencedata.ID) AS TOTALQUANTITY,
       BOA.getObsoNumberOfArticlesInStock(BOA.obsolescencedata.ID) AS STOCKQUANTITY,
       BOA.getObsoNumberOfArticlesInUse(BOA.obsolescencedata.ID) AS INUSEQUANTITY,
       BOA.obsolescencedata.MTBF,
       BOA.obsolescencedata.PERSONINCHARGE AS INCHARGEOF,
       BOA.getObsoManufacturer(BOA.obsolescencedata.ID) AS MANUFACTURER, BOA.obsolescencedata.SUPPLIER
...
SELECT DISTINCT BOA.installation.NAME AS Plateforme, BOA.aircraftprogram.DEFAULTVALUE AS Programme,
 BOA.installation.COMMENTS AS Comments, BOA.getUserName(BOA.installation.USER_ID) AS Person_In_Charge,
 view_PC.NAME AS Machine, view_PC.FUNCTION AS Utilisation,
 BOA.software.NAME AS Logiciel, BOA.software.DISTRIBUTION AS Distribution_Version_Logiciel, BOA.software.KERNEL AS Kernel_Logiciel
FROM BOA.installation
LEFT JOIN view_PC ON view_PC.MASTERPARENTTYPE = "Installation" AND view_PC.MASTERPARENT = BOA.installation.NAME
...
BOA.typearticle.LABEL AS TYPE,
BOA.getSoftwareName(BOA.software.ID) AS OS,
BOA.article.AIRBUSSN AS BARCODE,
BOA.getName(BOA.getLocationID(BOA.pc.ID,"PC")) AS ROOM,
...
BOA.getUserName(BOA.user.ID) AS USERS,
...
BOA.article.AIRBUSSN AS BARCODE,
BOA.getName(BOA.getLocationID(BOA.article.ID, "Board")) AS ROOM,
BOA.communicationport.SOCKET,
BOA.communicationport.MACADDRESS, BOA.communicationport.IPADDRESS,
BOA.installation.NAME AS PLATFORM_NAME,
BOA.installation.COMMENTS AS PLATFORM_DESIGNATION,
...
BOA.manufacturerpn.IDENTIFIER AS OS,
BOA.article.AIRBUSSN AS BARCODE,
BOA.getName(BOA.getLocationID(BOA.article.ID, "Various")) AS ROOM,
...
BOA.getUserName(BOA.pc.USER_ID) AS PC_IN_CHARGE,
...
BOA.installation.COMMENTS AS PLATFORM_DESIGNATION,
BOA.aircraftprogram.DEFAULTVALUE AS PROGRAM,
BOA.getUserName(BOA.installation.USER_ID) AS PLATFORM_IN_CHARGE,
BOA.installation.BUSINESSSIGLUM AS PLATFORM_BUSINESS_SIGLUM
FROM BOA.pc
LEFT JOIN BOA.article ON BOA.article.ID = BOA.pc.ID
LEFT JOIN BOA.typearticle ON BOA.typearticle.ID = BOA.article.TYPEARTICLE_ID
LEFT JOIN BOA.installation ON BOA.installation.ID = BOA.getMasterContainerID(BOA.article.ID, "PC")
LEFT JOIN BOA.aircraftprogram ON BOA.aircraftprogram.ID = BOA.installation.AIRCRAFTPROGRAM_ID
